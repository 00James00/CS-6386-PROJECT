...
#second plot
# The following plot code shows the number of iterations vs. number of components (feature preprocessor) used in pipeline
# iterations_for_num_components = {}  

avg_iterations_list = []

# # Iterate over the number of components.
for num_components in range(0, 6):  # Looping from 1 to 6 components
...
# Plot the results
plt.figure()
plt.scatter(range(6, 0), avg_iterations_list)
